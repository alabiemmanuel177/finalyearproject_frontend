...
const Profile = ({ admin, department }) => {
            ...
            <div className="personalInfo flexRow">
                ...
                <div className="personalInfoForm">
                    <div>
                        ...
                        <input type="text" className='mgb68' placeholder='Name' value={admin.name || ""} readOnly />
                    </div>
                    <h4 className="label">Email</h4>
                    <input type="text" placeholder='Email' value={admin.email || ""} readOnly />
                </div>
            </div>
            <hr />
